        ...
        <main className="flex-1 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
          ...
          {activeTab === "profile" && (
            ...
            >
              ...
              {/* Card 4: Educational Credentials */}
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-5 sm:p-6 shadow-xs space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-base font-semibold text-slate-900 dark:text-white">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-5 sm:p-6 shadow-xs space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                  ...
                  <div
                    ...
                    className={`p-4 rounded-xl border-2 transition-all cursor-pointer space-y-3 select-none ${
                      navMode === "sidebar"
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-5 sm:p-6 shadow-xs space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-1">
                  <button
                    ...
                    className={`p-3.5 rounded-xl border-2 flex items-center gap-3 transition-all cursor-pointer text-left ${
                      theme === "light"
