    ...
    >
      <div className="w-full max-w-5xl bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 grid md:grid-cols-12 overflow-hidden">
        ...
        <motion.div
          ...
          className="md:col-span-5 relative bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 p-5 sm:p-6 lg:p-7 text-white flex flex-col justify-between"
        >
          <div className="space-y-4">
            ...
            <div className="space-y-2.5 pt-1">
              {[
                ...
                <div
                  key={index}
                  className="flex items-start gap-3 bg-white/10 dark:bg-white/5 border border-white/10 p-2.5 sm:p-3 rounded-2xl backdrop-blur-md"
                >
                  <div className="p-1.5 rounded-xl bg-white/10 mt-0.5 shrink-0">{item.icon}</div>
                  <div>
        ...
        <motion.div
          ...
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.5 }}
          className="md:col-span-7 p-5 sm:p-6 lg:p-7 bg-white dark:bg-slate-900 space-y-4 flex flex-col justify-between"
        >
          <div>
            <div className="mb-3">
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-medium focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-medium focus:border-blue-500 outline-none transition"
                ...
                <div>
                  ...
                  <select
                    ...
                    value={mode}
                    className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-medium focus:border-blue-500 outline-none cursor-pointer"
                  >
              ...
              {!analysisDone ? (
                ...
                >
                  <FaFileUpload className="text-lg mx-auto text-blue-600 mb-1" />
                  <input
                    type="file"
