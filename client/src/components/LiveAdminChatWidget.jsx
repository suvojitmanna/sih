      ...
      <div className="fixed bottom-6 right-6 z-50 select-none">
        {!isOpen && (
          <button
            ...
            className="relative group p-3.5 sm:p-4 rounded-3xl bg-gradient-to-r from-blue-700 via-indigo-700 to-slate-900 text-white shadow-2xl hover:shadow-blue-500/25 hover:scale-105 transition-all duration-300 flex items-center gap-3.5 cursor-pointer border-2 border-blue-400/40 backdrop-blur-md"
                    ...
                    messages.map((msg, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div
                            className={`max-w-[85%] p-3.5 rounded-3xl text-xs leading-relaxed space-y-2 shadow-xs ${
                              isOfficer
